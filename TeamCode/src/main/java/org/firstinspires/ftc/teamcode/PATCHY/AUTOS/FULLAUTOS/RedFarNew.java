...
@Config
@Autonomous(name = "Red, Far From Backdrop", group = "Final Autos")
public class RedFarNew extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(-36.00, -62.75, Math.toRadians(90.00));
        ...
        TrajectorySequence blueBackdropLeftTrajs1 = drive.trajectorySequenceBuilder(startPose)
                .lineTo(new Vector2d(-36.00, -60.75))
                .lineTo(new Vector2d(-47.00, -60.75))
                .lineTo(new Vector2d(-47.00, -45.00))
                .waitSeconds(2)
                .addTemporalMarker(0, () -> {
                    robot.intakeRight.setPosition(.94);
                    gripper.setPosition(.6);
        ...
        TrajectorySequence blueBackdropLeftTrajs2 = drive.trajectorySequenceBuilder(blueBackdropLeftTrajs1.end())
                ...
                .lineTo(new Vector2d(-36.00, -50.00))
        ...
        TrajectorySequence blueBackdropRightTrajs3 = drive.trajectorySequenceBuilder(blueBackdropRightTrajs2.end())
                ...
                .lineTo(new Vector2d(50.50, -45))
                .waitSeconds(2)
                .lineTo(new Vector2d(46, -45))
                .build();
        ...
        while (!isStarted() && !isStopRequested()) {
            ...
            if (bluepropPipeline.getPropPosition() == "left"){
                state = 10;
                parkPose = (new Pose2d(46, -27, Math.toRadians(180)));
